...
if confirm "Are you sure to install the program ?"; then
    ...
    cd /home/pi/
    sudo wget https://raw.githubusercontent.com/felix068/Raspi_RDP_Client/main/profile -O '.profile'
    sudo wget https://raw.githubusercontent.com/felix068/Raspi_RDP_Client/main/xinitrc -O '.xinitrc'
    cd /
